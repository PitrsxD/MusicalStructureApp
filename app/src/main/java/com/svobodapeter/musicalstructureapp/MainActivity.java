...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Intent which will open Playing.class from MainActivity.class
         */
        ...
        playActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                ...
                Intent mainIntentActivity = new Intent(MainActivity.this,Playing.class);
    ...
    class SongPreviewAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
            ...
            /**
             * SetOnClickListener is called everytime, when is selected song in RecyclerView. Intent is opening
             * Playing.class to play selected song
             *
             */
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent myIntent = new Intent (MainActivity.this,Playing.class);
                    myIntent.putExtra("Artist",((TextView) findViewById(R.id.artist_name)).getText().toString());
                    myIntent.putExtra("Song",((TextView) findViewById(R.id.song_name)).getText().toString());
    ...
    private List<SongPreview> trendMusicMethod(){
        ...
        trendMusic.add(new SongPreview(R.mipmap.blank_image,"Name name", "Song name"));
        trendMusic.add(new SongPreview(R.mipmap.blank_image,"Name name2", "Song name"));
        trendMusic.add(new SongPreview(R.mipmap.blank_image,"Name name3", "Song name"));
        trendMusic.add(new SongPreview(R.mipmap.blank_image,"Name name4", "Song name"));
    ...
    private List<SongPreview> electronicMusicMethod(){
        ...
        elecMusic.add(new SongPreview(R.mipmap.blank_image2,"Name name", "Song name"));
        elecMusic.add(new SongPreview(R.mipmap.blank_image,"Name name2", "Song name"));
        elecMusic.add(new SongPreview(R.mipmap.blank_image,"Name name3", "Song name"));
        elecMusic.add(new SongPreview(R.mipmap.blank_image,"Name name4", "Song name"));
    ...
    private List<SongPreview> popMusicMethod(){
        ...
        popMusic.add(new SongPreview(R.mipmap.blank_image,"Name name", "Song name"));
        popMusic.add(new SongPreview(R.mipmap.blank_image,"Name name2", "Song name"));
        popMusic.add(new SongPreview(R.mipmap.blank_image,"Name name3", "Song name"));
        popMusic.add(new SongPreview(R.mipmap.blank_image,"Name name4", "Song name"));
    ...
    private List<SongPreview> rockMusicMethod(){
        ...
        rockMusic.add(new SongPreview(R.mipmap.blank_image,"Name name", "Song name"));
        rockMusic.add(new SongPreview(R.mipmap.blank_image,"Name name2", "Song name"));
        rockMusic.add(new SongPreview(R.mipmap.blank_image,"Name name3", "Song name"));
        rockMusic.add(new SongPreview(R.mipmap.blank_image,"Name name4", "Song name"));
